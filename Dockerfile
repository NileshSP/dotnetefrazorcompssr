...
RUN dotnet build ./app/DotnetEFRazorCompSSR.App/DotnetEFRazorCompSSR.App.csproj 
#--no-restore

RUN dotnet publish ./app/DotnetEFRazorCompSSR.App/DotnetEFRazorCompSSR.App.csproj 
